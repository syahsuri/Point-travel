...
export default function SidePanel({
  ...
  return (
    <div className={`absolute right-2 top-14 md:right-4 md:top-4 z-20 flex max-h-[50vh] md:max-h-[calc(100dvh-8rem)] flex-col overflow-hidden rounded-md border border-white/10 bg-black/80 md:bg-black/55 text-xs backdrop-blur shadow-lg transition-all w-[calc(100vw-1rem)] md:w-80`}>
